...
A [skill](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/skills) is a set of instructions - packaged as a simple folder - that teaches Claude how to handle specific tasks or workflows. Skills are one of the most powerful ways to customize Claude for your specific needs. Instead of re-explaining your preferences, processes, and domain expertise in every conversation, skills let you teach Claude once and benefit every time.
...
If you already have a [working MCP server](https://modelcontextprotocol.io/quickstart/server), you've done the hard part. Skills are the knowledge layer on top - capturing the workflows and best practices you already know, so Claude can apply them consistently.
...
*Real example:* [frontend-design skill](https://github.com/anthropics/skills/tree/main/frontend-design) (also see [skills for docx, pptx, xlsx, and ppt](https://github.com/anthropics/skills/tree/main/office-suite))
...
According to Anthropic's [engineering blog](https://www.anthropic.com/engineering/building-skills-for-claude): "This metadata...provides just enough information for Claude to know when each skill should be used without loading all of it into context." This is the first level of progressive disclosure.
...
- [Skills API Quickstart](https://docs.anthropic.com/en/docs/agents-and-tools/skills/api-quickstart)
- [Create Custom skills](https://docs.anthropic.com/en/docs/agents-and-tools/skills/custom-skills)
...
- [Engineering Blog: Equipping Agents for the Real World](https://www.anthropic.com/engineering/building-skills-for-claude)
...
- [Building Skills for Claude Code](https://www.anthropic.com/news/building-skills-claude-code)
